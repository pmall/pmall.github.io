...
As part of my exploration into generative AI for biology, I undertook a project to build Mímir, a generative peptide binder model, by fine-tuning [ESM3](https://www.evolutionaryscale.ai/), a 1.4-billion parameter protein language model. The goal was to train the model to generate novel binding sequences based on target protein 3D structures.
