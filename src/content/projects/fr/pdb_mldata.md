...
Dans le cadre de mon travail actuel sur une future version de [Mímir](#mimir), j'explore la **PDB** pour construire un dataset propre de paires peptide-récepteur destiné au machine learning.
