...
Dans le cadre de mon exploration de l'IA générative appliquée à la biologie, j'ai entrepris la création de Mímir, un modèle de génération de peptides liants, en fine-tunant [ESM3](https://www.evolutionaryscale.ai/), un modèle de langage de protéines de 1,4 milliard de paramètres. L'objectif était d'entraîner le modèle à générer de nouvelles séquences liantes en se basant sur la structure 3D de protéines cibles.
